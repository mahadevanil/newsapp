...
abstract class $ThemeStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({ThemeType? themeType, LoadingStatus loadingStatus});
}
...
class _$ThemeStateImpl implements _ThemeState {
  ...
  @override
  String toString() {
    return 'ThemeState(themeType: $themeType, loadingStatus: $loadingStatus)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, themeType, loadingStatus);
...
abstract class _ThemeState implements ThemeState {
  const factory _ThemeState(
      {final ThemeType? themeType,
      final LoadingStatus loadingStatus}) = _$ThemeStateImpl;
