...
class _$SplashStateImpl implements _SplashState {
  const _$SplashStateImpl({this.loadingStatus = LoadingStatus.initial});
  ...
  @override
  String toString() {
    return 'SplashState(loadingStatus: $loadingStatus)';
  }
...
abstract class _SplashState implements SplashState {
  const factory _SplashState({final LoadingStatus loadingStatus}) =
      _$SplashStateImpl;
